...
def train_only_bob():
    ...
    opt_enc = torch.optim.Adam(enc.parameters(), lr=lr, weight_decay=1e-6)
    opt_dec = torch.optim.Adam(dec.parameters(), lr=lr, weight_decay=1e-6)
    ...
    for epoch in range(1, max_epochs+1):
        ...
        print(f"Epoch {epoch:4d} - BER_B: {ber_B:.4f}")
